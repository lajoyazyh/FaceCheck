...
public class InMemoryHuaweiObsStorageService implements HuaweiObsStorageService {
    ...
    public InMemoryHuaweiObsStorageService(HuaweiCloudProperties properties, ObjectKeyStrategy objectKeyStrategy) {
